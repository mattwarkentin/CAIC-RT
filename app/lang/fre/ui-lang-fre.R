...
summary_vent <- "Ayant {n_vent} dispositifs de ventilation mécanique et présupposant une durée moyenne de {lou_vent} jours sous ventilation mécanique, à capacité maximale, le taux de rotation prévu pour ce système de soins est de {ventBedRate} dispositifs de ventilation mécanique libérés par jour. Selon la distribution d'âge des cas, la proportion de cas de COVID-19 nécessitant un dispositif de ventilation mécanique est de {rateVent} pour cent. Compte tenu de cela, ce système de santé a la capacité de gérer un maximum de {maxVent} nouveaux cas de COVID-19 par jour."
