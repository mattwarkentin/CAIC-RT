...
knitr::asis_output('\\item{Vasily Giannakeas, MPH \textsuperscript{1,2}}')
knitr::asis_output('\\item{Deepit Bhatia, MPH}')
knitr::asis_output('\\item{Matthew T. Warkentin, MSc \textsuperscript{2,3}}')
knitr::asis_output('\\item{Isaac I. Bogoch, MD \\textsuperscript{4,5}}')
knitr::asis_output('\\item{Nathan M. Stall, MD \textsuperscript{1,4,6,7}}')
...
```{r desc}
knitr::asis_output(
  glue('\\textbf{<<params$desc_title>>}: ', '<<params$desc>>', 
       .open = '<<', .close = '>>')
)
```
