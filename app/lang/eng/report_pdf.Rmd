...
```{r results='asis'}
glue('Based on {params$outputs$acute[[1]]} available mechanical ventilators with an average duration of use of {params$outputs$acute[[2]]} days, at maximum capacity the expected turnover rate is {params$outputs$acute[[3]]} ventilators per day. Based on the age-stratified case distribution, the proportion of COVID-19 cases requiring mechanical ventilation is {params$outputs$ra} percent. Given this, your healthcare environment has the capacity to manage a maximum of {params$outputs$ma} incident cases of COVID-19 per day.')
```

```{r results='asis'}
glue('Based on {params$outputs$crit[[1]]} available mechanical ventilators with an average duration of use of {params$outputs$crit[[2]]} days, at maximum capacity the expected turnover rate is {params$outputs$crit[[3]]} ventilators per day. Based on the age-stratified case distribution, the proportion of COVID-19 cases requiring mechanical ventilation is {params$outputs$rc} percent. Given this, your healthcare environment has the capacity to manage a maximum of {params$outputs$mc} incident cases of COVID-19 per day.')
```

```{r results='asis'}
glue('Based on {params$outputs$mvd[[1]]} available mechanical ventilators with an average duration of use of {params$outputs$mvd[[2]]} days, at maximum capacity the expected turnover rate is {params$outputs$mvd[[3]]} ventilators per day. Based on the age-stratified case distribution, the proportion of COVID-19 cases requiring mechanical ventilation is {params$outputs$rv} percent. Given this, your healthcare environment has the capacity to manage a maximum of {params$outputs$mv} incident cases of COVID-19 per day.')
```
