...
- Added a new modal widget for aiding users to compute the mean length of stay in acute care for COVID-19 patients
  + The widget accounts for patient-time for those who only spent time in acute care, and also those who spent time in acute care before or after spending time in critical care.
